...
from elasticsearch import TransportError, ElasticsearchException, Elasticsearch
...
def check_doc_exists(es_instance, my_index, my_type, _doc_id):
	# TODO: for exists, edit elasticsearch.yml, add "discovery.zen.ping.multicast.enabled: false"
	return es_instance.exists(index=my_index, doc_type=my_type, id=_doc_id)
